        ...
        <header class="post-header">
            <h2 class="post-title">
                <a href="<%=Post.RelativeOrAbsoluteLink %>"><%=Server.HtmlEncode(Post.Title) %>
                    <span class="post-title-chapter">&nbsp &nbsp Siman #: <%= Post.ChapterNumber %></span></a>
            </h2>
            <span class="post-chapter">Siman #: <%= Post.ChapterNumber %></span>
            <div class="post-info clearfix">
                ...
                <span class="post-category">Seif: <%= Post.Verses %></span>
